...
class ActionGetFAQAnswer(Action):
    ...
    def __init__(self):
        ...
        encode_standard_question(self.bc)
        self.faq_data = json.load(open("./faq.json", "rt", encoding="utf-8"))
        self.standard_questions_encoder = np.load("./standard_questions.npy")
        self.standard_questions_encoder_len = np.load("./standard_questions_len.npy")
...
def encode_standard_question(bc):
    data = json.load(open("./faq.json", "rt", encoding="utf-8"))
